...
export const pt = {
  ...
  mobileMvp: {
    ...
    controls: {
      ...
      powerShort: "Liga / desliga",
      volumeUpTitle: "Aumenta o volume",
      volumeDownTitle: "Abaixa o volume",
      powerTitle: "Liga e desliga o aparelho",
      muted: "Mudo",
    },
    share: {
      trigger: "Compartilhar",
      triggerTitle: "Compartilhar esta seção",
      title: "Compartilhar",
      text: "Desenvolvimento mobile — Lucas S.B. Jordão",
      copy: "Copiar link",
      copied: "Link copiado!",
      native: "Compartilhar via…",
      networks: {
        x: "X",
        facebook: "Facebook",
        linkedin: "LinkedIn",
